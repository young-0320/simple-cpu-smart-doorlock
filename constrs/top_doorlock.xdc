...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { btn_input }]; #IO_L6P_T0_34 Sch=jd_p[2]                  
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { btn_confirm }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]             
